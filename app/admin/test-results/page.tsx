  ...
  const [results, students, satDatesRaw] = await Promise.all([
    sql`
      SELECT tr.id, tr.student_id, u.name AS student_name,
             ...
             tr.math_score, tr.reading_writing_score, tr.notes, tr.notes_visible_to_student, tr.pdf_url,
             tr.score_type, tr.act_english_score, tr.act_reading_score, tr.act_science_score, tr.created_at
