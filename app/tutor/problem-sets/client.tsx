        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="pt-1">
            <button
              ...
              style={{
                background: saving || !problemFile ? 'var(--fog)' : 'var(--rose)',
      ...
      <div className="space-y-4">
        ...
        {problemSets.length === 0 ? (
          <div className="portal-card flex flex-col items-center justify-center py-16 text-center">
            ...
            >
              <FileText className="h-5 w-5" style={{ color: 'var(--rose-deeper)' }} />
            </div>
          ...
          <div className="space-y-2">
            {problemSets.map((ps, idx) => (
              <div
                ...
                onMouseEnter={(e) => { (e.currentTarget as HTMLDivElement).style.borderColor = 'rgba(224,166,175,0.3)'; }}
