...
import { LayoutDashboard, CalendarDays, Coffee, BookOpen, BarChart2, Settings, LogOut, FileText } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/tutor/act-test', label: 'ACT Test', icon: FileText },
          ...
          return (
            <Link
              ...
              style={{
                ...
                color: active ? 'var(--sky-deeper)' : 'var(--slate)',
                background: active ? 'rgba(168,203,222,0.14)' : 'transparent',
